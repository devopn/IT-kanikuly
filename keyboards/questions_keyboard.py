...
def get_questions_keyboard() -> types.InlineKeyboardMarkup:
    ...
    kb.add(types.InlineKeyboardButton(text="Мои достижения", callback_data="questions:my"))
    kb.add(types.InlineKeyboardButton(text="Мои задания", callback_data="questions:my"))
    kb.add(types.InlineKeyboardButton(text="Ежедневные задания", callback_data="questions:daily"))
